...
public class EjemploParamsController {
	...
	public String mix_param(@RequestParam String saludo,@RequestParam Integer numero,Model model) {
		model.addAttribute("resultado", "El saludo enviado es: '"+saludo+"' y el numero es: '"+numero+"'.");
		return "params/ver";
	}
	@GetMapping("/servlets-params")
	public String servlets_param(HttpServletRequest request,Model model) {
